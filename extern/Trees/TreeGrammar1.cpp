...
TG1Tree::TG1Tree()
{
    ...
    m_pLevels[0].diameter = 3.3f;
    m_pLevels[0].taper = 0.3f;
    ...
    m_pLevels[0].splitList[0].type = ORDINARY;//OPPOSED
    ...
    m_pLevels[2].splitList[0].probability = 0.25f;
    m_pLevels[2].splitList[0].splitCount = 1;
    m_pLevels[2].splitList[0].type = REPEAT_OPPOSED;
    m_pLevels[2].splitList[1].probability = 0.25f;
    m_pLevels[2].splitList[1].splitCount = 1;
    m_pLevels[2].splitList[1].type = OPPOSED;
    m_pLevels[2].splitList[2].probability = 0.5f;
    ...
    m_pLevels[3].splitList[1].splitCount = 4;
    m_pLevels[3].splitList[1].type = OPPOSED;
