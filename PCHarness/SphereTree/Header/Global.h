...
ID3D10EffectTechnique*  g_pSphereTechnique = NULL;
...
ID3D10EffectVectorVariable*         g_pElVariable                = NULL;
...
//ID3D10EffectScalarVariable*         g_pKdiffuseVariable         = NULL;
//ID3D10EffectScalarVariable*         g_pKspecularVariable        = NULL;
ID3D10ShaderResourceView*           g_pTexRV                = NULL;
